...
void menu_title() // The top part of the menus with name/version
{
    system("cls");
    printf("\t\t==================================\n");
    printf("\t\t||   Cinema Management  v0.99a  ||\n");
    printf("\t\t----------------------------------\n");
...
void assocs_menu()
{
    ...
    do {
        ...
        printf("\t\t==================================\n");
        printf("\t\t||                              ||\n");
        printf("\t\t|| [1] Associate movies/cinemas ||\n");  //
        printf("\t\t|| [2] Edit movies/cinemas as.  ||\n");  //
        printf("\t\t|| [3] Delete movies/cinemas as.||\n");  //
        printf("\t\t|| [4] Associate movies/actors  ||\n");  //
        printf("\t\t|| [5] Edit movies/actors as.   ||\n");  //
        printf("\t\t|| [6] Delete movies/actors as. ||\n");
        printf("\t\t||                              ||\n");
        printf("\t\t||                              ||\n");  //
        printf("\t\t|| [9] Save changes             ||\n");  //
        printf("\t\t||                              ||\n");
        printf("\t\t|| [R] Return to menu           ||\n");
        printf("\t\t||                              ||\n");
        printf("\t\t==================================\n");
...
void edit_movies_cinemas_assocs()
{
    int i=0,k=0,j=0,cnt=0;
    int mov,cin,ac;
    list_cinemas();
...
void delete_movies_cinemas_assocs()
{
    int i=0,k=0,j=0;
    int cin,ac;
    char ct[NAME_SIZE];
...
void edit_movies_actors_assocs()
{
    int i=0,k=0,j=0,cnt=0;
    int mov,act,ac;
    list_movies();
...
void delete_movies_actors_assocs()
{
    int i=0,k=0,j=0;
    int mov,ac;
    char ct[NAME_SIZE];
